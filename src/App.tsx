...
import { Mail, Phone, MessageCircle, MapPin, CheckCircle2, Wrench, Car, ShieldCheck, Building2, Menu, X, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <div className="flex flex-col items-center justify-center mb-8">
            <img 
              ...
              alt="Proton Logo" 
              className="h-12 lg:h-16 object-contain mb-2 brightness-0 invert"
              referrerPolicy="no-referrer"
            />
          </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-xs text-gray-500 space-y-2">
            <p>COPYRIGHT © 2026 - protonhafiz.com - Penasihat Jualan Proton. All Right Reserved.</p>
            ...
            <p>Web Design By <a href="https://www.piteghi.xyz" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white font-bold transition-colors">Fitri Mahadzir</a></p>
          </div>
        </div>
      </footer>
    </div>
